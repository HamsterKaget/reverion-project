...
@section('body')
    ...
    <section class="section-animate relative py-16 lg:py-36 rpg-pattern overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <!-- Download Client Section - Centered -->
            ...
            {{-- <div class="text-center mb-16">
                ...
                <div class="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-left">
                            <h3 class="text-lg font-semibold text-white mb-1">Enhanced Gameplay</h3>
                            <p class="text-sm text-gray-300">Custom rates, balanced PvP</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center">
                        ...
                        <div class="text-left">
                            <h3 class="text-lg font-semibold text-white mb-1">Active Community</h3>
                            <p class="text-sm text-gray-300">Join thousands of players</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center">
                        ...
                        <div class="text-left">
                            <h3 class="text-lg font-semibold text-white mb-1">Secure & Stable</h3>
                            <p class="text-sm text-gray-300">24/7 uptime guaranteed</p>
                        </div>
                    </div>
                </div>
            </div> --}}
